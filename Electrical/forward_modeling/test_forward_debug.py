...
GMES_ROOT = SCRIPT_DIR.parents[1]
...
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "debug_outputs"
...
if __name__ == "__main__":
    ...
    downsampled_bin = output_dir / "plot_fig1_data_res_model_50x50x50.bin"
    ...
    operator = MTForward3D(freqs, mt_dx, mt_dy, mt_dz)
